...
## Overview
My own list of "must watch before you die" movies. The list gets updated from time to time. My main intention to create such list was and still is to provide a solid "must watch before you die" overview of movies that I think are _gold_.


The list is alphabetical sorted but I do not say movie X is better than Y because it's simply hard or almost impossible to rate specific art over another one because there are a lot of variables to consider like the genre itself, the budget as well as the script and how many time someone had to create the movie.


## Table of Contents
* [CK's Movie List](#cks-movie-list)
  * [Overview](#overview)
  * [Table of Contents](#table-of-contents)
    * [Are you a movie reviewer or somehow involved into movie making?](#are-you-a-movie-reviewer-or-somehow-involved-into-movie-making)
    * [What do you classify as good movie?](#what-do-you-classify-as-good-movie)
    * [Do you have a all time fav movie?](#do-you-have-a-all-time-fav-movie)
    * [Why do you rewatch movies and is it worth it?](#why-do-you-rewatch-movies-and-is-it-worth-it)
    * [Do you have a fav movie genre, or how you rate specific genres?](#do-you-have-a-fav-movie-genre-or-how-you-rate-specific-genres)
  * [Action](#action)
...
### Are you a movie reviewer or somehow involved into movie making?

**No**, I'm not a professional reviewer nor do I get paid here to "advertise" any movie. I do it because I like quality movies and I wanted to share my experience. After watching movies for over 40 years now I still not consider me as _expert_ because I like to keep my point of view (_if possible_) objective and critical when I give my own personal review about a movie.
...
* Graphics as well as solid and fitting animations (depends if it's an animated movie or not and if there is C.G.I or not)
* A good movie does not need lots or C.G.I. at all there are good examples like the Alien movies with (_almost_) no C.G.I. in it.
* The movie should inspire me or open my mind which means that I think over the movie/story/characters after I watched it. I do not like brainless movies which I forgot the moment after I watched it.


### Do you have a all time fav movie?

A stated above that it's almost impossible to say or rate one movie above another one because the variables, but if I would give an honest answer I would say:
...
Another reason is that I appreciate the art in the movie itself. For most people the movie seems compared to modern standards - _boring_ (_it's not_) because there are no C.G.I in it - but let me tell you that this movie is ground breaking in many ways because it lead the way to modern movies and motivated & inspired well-known regisseurs like [Spielberg](https://nl.wikipedia.org/wiki/Steven_Spielberg).
...
* __**Horror**__ (_but I do not like splatter films because they look often "cheap"_)
* Psycho
